    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        .ma-root { font-family: 'Poppins', sans-serif; background: #f8f7ff; min-height: 100vh; color: #1c0b4b; -webkit-font-smoothing: antialiased; }
        .ma-loader { min-height: 60vh; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 1rem; color: #9ca3af; font-size: .9rem; }
        .ma-spinner { width: 40px; height: 40px; border: 3px solid #ede9fe; border-top-color: #7c3aed; border-radius: 50%; animation: ma-spin .8s linear infinite; }
        @keyframes ma-spin { to { transform: rotate(360deg); } }
        .ma-hero { background: #1c0b4b; padding: 2.75rem 5% 2.25rem; position: relative; overflow: hidden; }
        .ma-hero::before { content:''; position:absolute; top:-140px; right:-140px; width:420px; height:420px; background: radial-gradient(circle,rgba(124,58,237,.22) 0%,transparent 65%); pointer-events:none; }
        .ma-hero-inner { max-width:1300px; margin:0 auto; position:relative; z-index:1; }
        .ma-hero-tag { font-size:.72rem; font-weight:600; letter-spacing:.12em; text-transform:uppercase; color:#a78bfa; margin-bottom:.45rem; }
        .ma-hero-title { font-size: clamp(1.4rem,3vw,2rem); font-weight:800; color:white; letter-spacing:-.03em; line-height:1.2; margin-bottom:.35rem; }
        ...
        .ma-stats { display: grid; grid-template-columns: repeat(6,1fr); gap:.875rem; margin-bottom:1.75rem; }
        ...
        .ma-stat { background:white; border:1.5px solid #f3f4f6; border-radius:14px; padding:1.1rem 1rem; display:flex; flex-direction:column; gap:.45rem; transition:all .2s; cursor:default; }
        .ma-stat:hover { border-color:#ddd6fe; box-shadow:0 4px 16px rgba(124,58,237,.08); }
        .ma-stat-icon { width:34px; height:34px; border-radius:9px; display:flex; align-items:center; justify-content:center; }
        ...
        .ma-tabs { display:flex; gap:.375rem; overflow-x:auto; padding-bottom:.25rem; margin-bottom:1.5rem; scrollbar-width:none; -ms-overflow-style:none; }
        .ma-tabs::-webkit-scrollbar { display:none; }
        .ma-tab { display:inline-flex; align-items:center; gap:.35rem; padding:.45rem .9rem; border:1.5px solid #f3f4f6; border-radius:100px; background:white; font-family:'Poppins',sans-serif; font-size:.76rem; font-weight:600; color:#6b7280; cursor:pointer; transition:all .18s; white-space:nowrap; flex-shrink:0; }
        .ma-tab:hover { border-color:#c4b5fd; color:#7c3aed; }
        .ma-tab.on { background:#7c3aed; color:white; border-color:#7c3aed; }
        .ma-tab-n { font-size:.65rem; font-weight:700; background:rgba(0,0,0,.1); padding:.08rem .38rem; border-radius:100px; }
        .ma-tab.on .ma-tab-n { background:rgba(255,255,255,.25); }
        .ma-list { display:flex; flex-direction:column; gap:1.1rem; }
        .ma-card { background:white; border:1.5px solid #f3f4f6; border-radius:18px; overflow:hidden; transition:all .22s; }
        ...
        .ma-ch { display:flex; justify-content:space-between; align-items:flex-start; gap:.875rem; margin-bottom:.9rem; }
        .ma-ch-left { flex:1; min-width:0; }
        .ma-job-title { font-size:.975rem; font-weight:700; color:#1c0b4b; display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; margin-bottom:.2rem; }
        .ma-job-link { font-size:.975rem; font-weight:700; color:#1c0b4b; text-decoration:none; display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; margin-bottom:.2rem; transition:color .18s; }
        .ma-job-link:hover { color:#7c3aed; }
        .ma-company { font-size:.8rem; font-weight:600; color:#7c3aed; }
        .ma-badge { display:inline-flex; align-items:center; gap:.35rem; font-size:.7rem; font-weight:700; padding:.32rem .8rem; border-radius:100px; border:1.5px solid; white-space:nowrap; flex-shrink:0; }
        .ma-badge svg { width:11px; height:11px; stroke:currentColor; fill:none; flex-shrink:0; }
        .ma-auto-badge { font-size:0.65rem; background:rgba(22,163,74,.1); color:#16a34a; padding:2px 6px; border-radius:12px; margin-left:4px; }
        .ma-done-badge { font-size:0.65rem; background:rgba(162,28,175,.1); color:#a21caf; padding:2px 6px; border-radius:12px; margin-left:4px; }
        .ma-meta { display:flex; flex-wrap:wrap; gap:.4rem; margin-bottom:.9rem; }
        .ma-chip { display:inline-flex; align-items:center; gap:.28rem; font-size:.73rem; font-weight:500; color:#6b7280; background:#f9fafb; border:1px solid #f3f4f6; padding:.25rem .6rem; border-radius:7px; }
        .ma-chip svg { width:11px; height:11px; stroke:#9ca3af; fill:none; flex-shrink:0; }
        .ma-cover { background:#f8f7ff; border:1.5px solid #ede9fe; border-radius:12px; padding:.9rem 1rem; margin-bottom:.9rem; }
        .ma-cover-label { font-size:.68rem; font-weight:700; color:#7c3aed; text-transform:uppercase; letter-spacing:.08em; margin-bottom:.35rem; }
        .ma-cover-text { font-size:.8rem; color:#6b7280; line-height:1.6; }
        .ma-iv { background:#f8f7ff; border:1.5px solid #ede9fe; border-radius:14px; padding:1rem 1.1rem; margin-bottom:.9rem; }
        .ma-iv-head { display:flex; justify-content:space-between; align-items:center; gap:.5rem; margin-bottom:.75rem; }
        .ma-iv-title { display:flex; align-items:center; gap:.375rem; font-size:.82rem; font-weight:700; color:#1c0b4b; }
        .ma-iv-title svg { width:14px; height:14px; stroke:#7c3aed; fill:none; }
        .ma-iv-status { font-size:.68rem; font-weight:700; padding:.2rem .6rem; border-radius:100px; border:1.5px solid; }
        .ma-iv-meta { display:flex; flex-wrap:wrap; gap:.75rem; }
        .ma-iv-item { display:flex; align-items:center; gap:.3rem; font-size:.76rem; font-weight:500; color:#6b7280; }
        .ma-iv-item svg { width:12px; height:12px; stroke:#a78bfa; fill:none; flex-shrink:0; }
        .ma-report { background:white; border:1px solid #f3f4f6; border-radius:10px; padding:.8rem 1rem; margin-top:.75rem; }
        .ma-report-title { font-size:.72rem; font-weight:700; color:#7c3aed; text-transform:uppercase; letter-spacing:.06em; margin-bottom:.6rem; }
        ...
        .ma-rs { text-align:center; background:#f9fafb; border-radius:8px; padding:.45rem .25rem; }
        ...
        .ma-btn { display:inline-flex; align-items:center; gap:.3rem; font-family:'Poppins',sans-serif; font-size:.76rem; font-weight:600; padding:.46rem .9rem; border-radius:9px; text-decoration:none; cursor:pointer; border:none; transition:all .18s; white-space:nowrap; }
        ...
        .ma-empty { background:white; border:1.5px solid #f3f4f6; border-radius:20px; padding:4rem 2rem; text-align:center; }
        .ma-empty-icon { width:72px; height:72px; background:#f5f3ff; border-radius:20px; display:flex; align-items:center; justify-content:center; margin:0 auto 1.4rem; }
        ...
        .ma-browse { display:inline-flex; align-items:center; gap:.4rem; font-family:'Poppins',sans-serif; font-size:.875rem; font-weight:700; background:#7c3aed; color:white; padding:.75rem 1.75rem; border-radius:12px; text-decoration:none; transition:all .2s; }
                      ...
                      <div key={app.id} className="ma-card">
                        ...
                        <div className="ma-card-body">
                          ...
                          <div className="ma-actions">
                            {/* ✅ Give Interview Button - Shows when status is shortlisted */}
                            ...
                            {/* Join Interview - Shows when status is interview_scheduled */}
