...
const s = {
  ...
  progressTrack: { height: '4px', background: C.grey100, borderRadius: 0 },
  progressFill: (pct) => ({
    height: '100%', width: `${pct}%`,
    background: `linear-gradient(90deg, ${C.purple}, ${C.purpleMid})`,
    transition: 'width 0.5s ease', borderRadius: 0,
  }),
  divider: { height: '1px', background: C.grey100, margin: '0' },
  h1: { fontSize: '1.625rem', fontWeight: 700, color: C.grey900, margin: 0, lineHeight: 1.25 },
  h2: { fontSize: '1.25rem', fontWeight: 600, color: C.grey900, margin: 0 },
  body: { fontSize: '0.9rem', color: C.grey600, lineHeight: 1.65 },
  label: {
    fontSize: '0.75rem', fontWeight: 600, color: C.grey400,
    textTransform: 'uppercase', letterSpacing: '0.08em',
  },
  btn: {
    display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
    gap: '8px', padding: '0 24px', height: '44px', borderRadius: '10px',
    border: 'none', fontSize: '0.9rem', fontWeight: 600, cursor: 'pointer',
    transition: 'all 0.2s', fontFamily: "'Poppins', sans-serif", whiteSpace: 'nowrap',
  },
  btnPrimary:  { background: C.purple, color: C.white, boxShadow: `0 2px 12px ${C.purple}40` },
  btnOutline:  { background: C.white, color: C.purple, border: `1.5px solid ${C.purple}` },
  btnGhost:    { background: C.grey100, color: C.grey600, border: `1.5px solid ${C.grey200}` },
  btnDanger:   { background: C.red, color: C.white, boxShadow: `0 2px 12px ${C.red}30` },
  btnDisabled: { opacity: 0.45, cursor: 'not-allowed', pointerEvents: 'none' },
  questionBox: {
    background: C.grey50, border: `1px solid ${C.grey200}`,
    borderRadius: '12px', padding: '1.5rem',
    fontSize: '1.05rem', fontWeight: 500, color: C.grey900, lineHeight: 1.7,
  },
  textarea: {
    width: '100%', padding: '1rem',
    border: `1.5px solid ${C.grey200}`, borderRadius: '10px',
    fontSize: '0.9rem', fontFamily: "'Poppins', sans-serif",
    color: C.grey900, minHeight: '140px', resize: 'vertical',
    outline: 'none', transition: 'border-color 0.2s',
    background: C.white, boxSizing: 'border-box',
  },
  videoWrap: {
    width: '100%', borderRadius: '12px', overflow: 'hidden',
    background: C.grey900, position: 'relative', aspectRatio: '16/9',
  },
  video: { width: '100%', height: '100%', objectFit: 'cover', display: 'block' },
  tabRow: {
    display: 'flex', background: C.grey100,
    borderRadius: '10px', padding: '4px', gap: '4px',
  },
  tab: (active) => ({
    flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center',
    gap: '7px', padding: '8px 16px', borderRadius: '7px', border: 'none',
    background: active ? C.white : 'transparent',
    color: active ? C.purple : C.grey600,
    fontWeight: active ? 600 : 500, fontSize: '0.85rem', cursor: 'pointer',
    transition: 'all 0.2s',
  ...
  notice: (bg, border, color) => ({
    ...
    color: color, fontSize: '0.85rem', lineHeight: 1.55,
  }),
  recDot: {
    width: 10, height: 10, borderRadius: '50%',
    background: C.red, animation: 'blink 1.2s ease-in-out infinite',
  },
};
      ...
      <CenteredCard>
        <CenterBlock>
          ...
          <p style={{ ...s.body, maxWidth: 360, margin: '0.5rem auto 1.5rem' }}>
            Unable to reach the backend server. Make sure it is running.
          </p>
    ...
    <Page>
      <CenteredCard>
        <CenterBlock>
          ...
          <p style={{ ...s.body, marginTop: '0.4rem' }}>Generating your performance report…</p>
            ...
            <div style={{ marginTop: '1.5rem', marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                {[
                  ...
                  { icon: icons.mic,       text: 'Voice mode available — speak clearly for best results' },
            ...
            <div style={{ marginTop: '1.5rem' }}>
              ...
              {status === 'ready' && inputMode === 'text' && !processing && (
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  />
                  <div style={{ ...s.body, fontSize: '0.78rem', marginTop: '6px',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px',
                ...
                {status === 'recording' && (
                  <><div style={{ ...s.dot(C.red), animation: 'blink 1s ease-in-out infinite' }} />
                  <span style={{ ...s.body, fontSize: '0.78rem' }}>Recording — speak clearly</span></>
                )}
                {(status === 'processing' || processing) && (
